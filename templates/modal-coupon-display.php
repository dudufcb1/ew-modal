...
$settings = wp_parse_args($settings ?? array(), array(
    'show_header' => true,
...
<div class="<?php echo esc_attr($section_class); ?>" 
    ...
    <div class="ewm-coupon-header">
        <h4 class="ewm-coupon-title">
            <?php 
            $title = apply_filters('ewm_coupon_modal_title', __('Cupones Disponibles', 'ewm-modal-cta'), $modal_id);
            echo esc_html($title);
            ?>
        </h4>
        ...
        <div class="ewm-coupon-list" role="list">
            <?php if (!empty($coupons)): ?>
                ...
                foreach ($limited_coupons as $index => $coupon): 
                    ...
                    $coupon = wp_parse_args($coupon, array(
                        'code' => '',
                        'description' => '',
                        'discount_text' => '',
            ...
            <?php else: ?>
                ...
                <div class="ewm-no-coupons" role="status">
                    ...
                    <p class="ewm-no-coupons-message">
                        <?php 
                        $no_coupons_message = apply_filters('ewm_no_coupons_message', 
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    <?php foreach ($coupons as $index => $coupon): ?>
    {
      ...
      ,"validThrough": "<?php echo esc_js(date('c', strtotime($coupon['expires']))); ?>"
      <?php endif; ?>
