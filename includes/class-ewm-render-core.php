...
class EWM_Render_Core {
    ...
    public function render_modal($modal_id, $config = []) {
        ...
        ewm_log_info('RENDER DEBUG - validate_modal result', [
            'modal_id' => $modal_id,
            'valid' => $is_valid,
        ...
        ewm_log_info('RENDER DEBUG - modal_config', [
            'modal_id' => $modal_id,
        ...
        ewm_log_info('RENDER DEBUG - html generated', [
            'modal_id' => $modal_id,
    ...
    private function generate_modal_html($modal_id, $config) {
        ewm_log_info('RENDER DEBUG - generate_modal_html started', [
            'modal_id' => $modal_id,
        ...
        ewm_log_info('RENDER DEBUG - generate_modal_html completed', [
            'modal_id' => $modal_id,
    ...
    private function generate_modal_content($modal_id, $config) {
        ...
        error_log('EWM RENDER DEBUG - steps data: ' . json_encode($config['steps'] ?? []));
