...
// source: phar:///home/eduardo/.config/composer/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon
...
class Container_b15e3cc7fa extends _PHPStan_ac6dae9b0\Nette\DI\Container
{
	protected $tags = [
	...
	{
		return new PHPStan\Php\PhpVersionFactoryFactory(null, ['/home/eduardo/.config/composer']);
	}


	public function createService029(): PHPStan\Php\ComposerPhpVersionFactory
	{
		return new PHPStan\Php\ComposerPhpVersionFactory(['/home/eduardo/.config/composer']);
	}
	...
	public function createService045(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			...
			[
				...
				'/home/eduardo/.config/composer/vendor/php-stubs/wordpress-stubs/wordpress-stubs.php',
			],
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_b15e3cc7fa $container)
			{
	...
	public function createServiceContainer(): Container_b15e3cc7fa
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'paths' => [
				...
				'/var/www/html/plugins/wp-content/plugins/ewm-modal-cta/admin',
				'/var/www/html/plugins/wp-content/plugins/ewm-modal-cta/ewm-modal-cta.php',
				'/var/www/html/plugins/wp-content/plugins/ewm-modal-cta/add-caps.php',
				'/var/www/html/plugins/wp-content/plugins/ewm-modal-cta/fix-capabilities.php',
			],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'composerAutoloaderProjectPaths' => ['/home/eduardo/.config/composer'],
			'generateBaselineFile' => null,
			'usedLevel' => '5',
			'cliAutoloadFile' => null,
			'env' => [
				'SHELL' => '/bin/bash',
				'SESSION_MANAGER' => 'local/edulinux:@/tmp/.ICE-unix/1616,unix/edulinux:/tmp/.ICE-unix/1616',
				'QT_ACCESSIBILITY' => '1',
				'COLORTERM' => 'truecolor',
				...
				'GNOME_TERMINAL_SCREEN' => '/org/gnome/Terminal/screen/377d2a67_75e9_4872_b14e_6109080b348e',
				...
				'USER' => 'eduardo',
				'GIT_PAGER' => 'cat',
				'VSCODE_GIT_IPC_HANDLE' => '/run/user/1000/vscode-git-90d0c7cc47.sock',
				'GNOME_TERMINAL_SERVICE' => ':1.658',
				'DISPLAY' => ':0',
				'SHLVL' => '2',
				'NVM_CD_FLAGS' => '',
				'PAGER' => 'cat',
				...
				'GDK_BACKEND' => 'x11',
				'PATH' => '/home/eduardo/.config/composer/vendor/bin:/home/eduardo/bin:/home/eduardo/.config/composer/vendor/bin:/home/eduardo/bin:/home/eduardo/.nvm/versions/node/v22.17.0/bin:/home/eduardo/.local/bin:/home/eduardo/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:/home/eduardo/.local/bin:/home/eduardo/.local/bin:/home/eduardo/.config/Code/User/globalStorage/github.copilot-chat/debugCommand:/home/eduardo/.local/bin',
				'GDMSESSION' => 'cinnamon',
