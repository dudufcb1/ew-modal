...
class Container_301968b3d2 extends _PHPStan_ac6dae9b0\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_301968b3d2 $container)
			{
	...
	public function createServiceContainer(): Container_301968b3d2
	{
		return $this;
	}
