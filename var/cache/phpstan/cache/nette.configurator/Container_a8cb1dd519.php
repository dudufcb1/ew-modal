...
class Container_a8cb1dd519 extends _PHPStan_ac6dae9b0\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_a8cb1dd519 $container)
			{
	...
	public function createServiceContainer(): Container_a8cb1dd519
	{
		return $this;
	}
